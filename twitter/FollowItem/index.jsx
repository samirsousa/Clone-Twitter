...
import { getAvatar } from "../src/utils/generateImages";
    ...
    return (
        <div className='flex items-center justify-between py-3 hover:bg-gray-800 transition duration-200'>
            ...
            <div>
                ...
                <button className="bg-white text-black font-bold px-4 py-2 rounded-full border border-gray-300 hover:bg-gray-300 transition duration-200 ml-4">
                              Follow
                       </button>
